...
export default function TitleAnimation({ onDone }: { onDone: () => void }) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      onDone();
    }, 5000); // duration of second animation
  ...
  return (
    <div ref={root} className="h-screen w-screen flex flex-col items-center justify-center overflow-hidden ">
      ...
      <svg width="170" height="130" viewBox="0 0 170 149" fill="none" xmlns="http://www.w3.org/2000/svg" className='[mask-image:linear-gradient(to_bottom_left,white,transparent,transparent)]' style={{
            fill: "#9803fc", 
